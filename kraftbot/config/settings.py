...
class Settings(BaseSettings):
    ...
    default_system_prompt_file: Optional[str] = Field(None, env="DEFAULT_SYSTEM_PROMPT_FILE")
    ...
    enable_mcp_server: bool = Field(True, env="ENABLE_MCP_SERVER")  # Enabled for Sleeper fantasy football functionality
    ...
    def validate_environment(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "default_model": {
                ...
                "status": "✅ Valid" if self.default_model in self.available_models else "⚠️  Invalid",
